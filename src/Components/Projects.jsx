...
function FeaturedProjects({projects}) {
  ...
  return (
    <div id="Projects" className='scroll-mt-20'>
      ...
      <button onClick={()=>setShowAll((prev)=>!prev)} class="px-6 py-3 cursor-pointer mx-auto rounded-lg font-medium transition-all flex items-center gap-2 bg-slate-800 hover:bg-slate-700 active:bg-slate-700 text-white mb-8">
