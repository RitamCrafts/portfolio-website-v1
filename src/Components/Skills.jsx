        ...
        <div className="additional flex flex-col">
            <div className='additional-heading flex gap-2 mb-4'>
                <div className="about-me-icon bg-slate-500/40 h-8 w-8 rounded-lg flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-award text-slate-400" data-fg-d3bl168="0.8:43.2159:/src/app/App.tsx:522:17:23098:80:e:Award::::::B1kh" data-fgid-d3bl168=":r2d:"><path d="m15.477 12.89 1.515 8.526a.5.5 0 0 1-.81.47l-3.58-2.687a1 1 0 0 0-1.197 0l-3.586 2.686a.5.5 0 0 1-.81-.469l1.514-8.526"></path><circle cx="12" cy="8" r="6"></circle></svg>
                </div>
                <h3 className='text-xl font-semibold text-white/80'>
                    Addititional
                </h3>
            ...
            <div className='flex gap-3 flex-wrap'>
                {data.skills.additional.map((skill) => (
                    <AdditionalSkillCard text={skill} />
                ))}
