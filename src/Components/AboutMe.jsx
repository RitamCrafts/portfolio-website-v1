...
function AboutMe({data}) {
  return (
    <div>
      <div className="heading flex flex-row justify-left items-center gap-3 mb-2 scroll-mt-30" id='About'>
        <div className="about-me-icon bg-orange-500/10 h-12 w-12 rounded-lg flex justify-center items-center">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-user text-orange-500" data-fg-d3bl141="0.8:43.2159:/src/app/App.tsx:464:15:20704:46:e:User::::::wpV" data-fgid-d3bl141=":r1n:"><path d="M19 21v-2a4 4 0 0 0-4-4H9a4 4 0 0 0-4 4v2"></path><circle cx="12" cy="7" r="4"></circle></svg>
        </div>
