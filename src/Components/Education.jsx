    ...
    <div>
        ...
        <div className='flex flex-col gap-5'>
        {
            education.map((x,index)=>(
                <EducationCard key={index} educationDetails={education[index]}/>
            ))
        }
        </div>
